...
### What's Missing
- ❌ **Desktop-v2 Backend APIs:** 7 critical API modules for v0.1.0 features
...
- **Backend APIs:** 2-3 weeks (7 modules × 2-3 days each)
- **Frontend Migration:** 1 week (3 complex refactors + integration)
- **Testing & Polish:** 1 week
- **Total:** 4-5 weeks to v0.1.0 100%
...
#### 1. Images API (CRITICAL)
**Required for:** Location page image galleries, hero images

**Endpoints Needed:**
```javascript
window.api.images.getByLocation(locUuid, limit, offset)
window.api.images.getThumbnailUrl(assetId)
window.api.images.getOriginalUrl(assetId)
window.api.images.getMetadata(imgUuid)
```

**Database Tables:** images table (exists in schema)
**Dependencies:** File system access, path resolution
**Estimated Work:** 2-3 days

---

#### 2. Videos API (CRITICAL)
