...
4. **Link related concepts**
   ...
   - Link workflows to the scripts they use
   - Link JSON files to their corresponding tables

5. **Use consistent page naming**
   - Scripts: `db_migrate`, `db_import`, `db_organize`
   - Tables: `locations_table`, `images_table`, `videos_table`
   - JSON files: `folder_json`, `name_json`, `user_json`
   - Concepts: `aupat`, `aupat_import`, `aupat_webapp`

### Page Structure Best Practices

Each page should include:
- **Purpose**: What this component does
- **Related pages**: Links to related [[pages]] and #tags
- **Details**: Specifications, steps, or implementation details
- **Cross-references**: Links to parent/child components

### Example Logseq Page

```markdown
- Purpose: [[db_migrate]] creates and manages the database schema
- Related: #database #[[import pipeline]]
- Dependencies:
  - [[locations_table]]
  - [[images_table]]
  - [[versions_table]]
- Steps:
  - Load database config from [[user_json]]
  - Backup using [[backup]]
  - Check versions in [[versions_table]]
